<section class="relative w-full min-h-screen overflow-hidden flex items-center bg-[#0f1117] font-plus" id="contato">
    ...
    <div
        class="relative z-10 w-full px-4 sm:px-8 md:px-14 lg:px-20 xl:px-28 2xl:px-40
        ...
        <div class="w-full lg:w-1/2 xl:w-[45%] flex flex-col gap-6 sm:gap-8 lg:gap-10">
            ...
            <h2
                class="font-plus font-extrabold text-white leading-tight
            ...
            <div class="flex flex-col gap-5 sm:gap-6 mt-6">
                ...
                <div class="flex items-center gap-4">
                    <div
                        class="flex-shrink-0 flex items-center justify-center rounded-xl bg-orange-500/20 border border-orange-500/30
                    ...
                    <div>
                        <p
                            class="font-bold tracking-widest text-orange-400 uppercase
                      text-xs sm:text-sm lg:text-base xl:text-lg mb-0.5">
                            E-mail
                        </p>
                        <a href="mailto:contato@mirimweb.com.br"
                            class="text-gray-200 hover:text-orange-400 transition-colors duration-200
        ...
        <div
            class="w-full lg:w-1/2 xl:w-[55%]
                ...
                p-5 sm:p-6 md:p-8 lg:p-8 xl:p-10 2xl:p-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 xl:gap-6 mb-4 sm:mb-5 xl:mb-6">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="text" placeholder="Seu nome"
                        class="w-full bg-white/8 border border-white/15 rounded-xl text-white placeholder-gray-500
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="email" placeholder="exemplo@email.com.br"
                        class="w-full border border-white/15 rounded-xl text-white placeholder-gray-500
                   focus:outline-none focus:border-orange-500 focus:bg-white/10 transition-all duration-200
                   px-4 py-3 xl:px-5 xl:py-4 text-sm sm:text-base xl:text-lg"
                        style="background: rgba(255,255,255,0.06);">
                </div>
            ...
            <div class="flex flex-col gap-1.5 mb-4 sm:mb-5 xl:mb-6">
                ...
                <input type="text" placeholder="Como podemos ajudar a sua empresa?"
                    class="w-full border border-white/15 rounded-xl text-white placeholder-gray-500
                 focus:outline-none focus:border-orange-500 focus:bg-white/10 transition-all duration-200
                 px-4 py-3 xl:px-5 xl:py-4 text-sm sm:text-base xl:text-lg"
                    style="background: rgba(255,255,255,0.06);">
