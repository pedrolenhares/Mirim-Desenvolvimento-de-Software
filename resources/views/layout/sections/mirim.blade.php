  <section class="w-full min-h-screen flex flex-col px-4 sm:px-6 md:px-8 bg-[#f3f4f6] animated-background animate-fadeIn"
      ...
      <div class="max-w-6xl w-full mt-10 sm:mt-16 md:mt-20 text-left mb-8 sm:mb-12 relative z-10">
          ...
          <h2
              class="text-5xl sm:text-5xl md:text-4xl lg:text-5xl font-arial mb-6 sm:mb-8 pl-4 sm:pl-6 md:pl-10 animate-slideIn [animation-delay:0.5s] tracking-wide">
          ...
          <h2
              class="text-5xl sm:text-5xl md:text-4xl lg:text-5xl font-arial pl-8 sm:pl-12 md:pl-20 animate-slideIn [animation-delay:1s] tracking-wide">
